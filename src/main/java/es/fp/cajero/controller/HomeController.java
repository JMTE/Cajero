...
public class HomeController {
	...
	/*Esta anotación se utiliza para asignar solicitudes HTTP GET a métodos de controlador específicos. 
	  Este es nuestro comienzo de la aplicación, entramos por / y nos sale el jsp correspondiente al login*/
	 ...
	 * El Interface HttpSession proporciona métodos que almacenan y recuperan. Propiedades de Sesión Estándard
	 * como un identificador de sesión. En este caso lo utilizaremos para almacenar el valor de idCuenta */
